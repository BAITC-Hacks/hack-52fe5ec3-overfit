...
**Voice Router** — голосовой AI-робот для контакт-центра страховой компании **Saqta Insurance**.

Главная задача решения — не просто распознать речь и сгенерировать ответ, а **выбрать правильный бизнес-сценарий через LLM-слой**, сохраняя контекст диалога.
